...
dl {margin-bottom:50px; font-size: 13px;}
dl dt {float:left; font-weight:normal; margin-right:10px; padding:5px; width:150px; }
dd {margin:2px 0; padding:5px 0; width:850px;}
.header {font-family: Arial, sans-serif; font-size: 13px; background: #E00; border:1px solid #000; position: relative; min-height: 120px;}
.header p {position:relative; margin: 10px;}
.header dl {position:relative; margin-left: 10px; margin-right: 10px; margin-top: 10px; margin-bottom: 10px; }
.data { background: #FFF; border-top:1px solid #000; border-bottom:1px solid #000; }
#detail-title {font-family: Arial, sans-serif; font-size: 13px; background: #E00; border:1px solid #000; height: 20px; margin-top: 5px; padding: 10px;}
#iderrordata {font-family: Courier new; font-size: 13px;}
</style>
...
function koggle(elem)
{
	...
	return false;
        ...
        <div class="header">
            <p class="title"><strong>Basic Informations:</strong></p>
            <div class="data">
                <dl id="iderrordata">
                    <dt>Datetime:</dt>
...
<div id="detail-title"><strong>Error Details:</strong></div>
<div id="kohana_error">
